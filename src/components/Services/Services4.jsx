    ...
    <div className="flex flex-col items-center gap-8 w-full max-w-[1310px] mx-auto">
      ...
      <div className="flex gap-2 sm:gap-3 md:gap-4 lg:gap-[34px] w-full justify-center">
        {services.map((service) => (
          <div
            key={service.title}
            className="flex-none rounded-[12px] lg:rounded-[30px] p-[1px] 
          ...
          >
            ...
            >
              {/* Icon */}
              <div className="bg-[#0464DA] rounded-[6px] sm:rounded-[8px] lg:rounded-[12px] 
                              w-[15px] sm:w-[28px] md:w-[36px] lg:w-[42px] 
                              h-[15px] sm:h-[28px] md:h-[36px] lg:h-[42px] 
